object M_deliveryTermFRM: TM_deliveryTermFRM
  Left = 365
  Top = 153
  Caption = 'Instructor'
  ClientHeight = 558
  ...
  object Panel3: TPanel
    ...
    object Grid1: TwwDBGrid
      ...
      Selected.Strings = (
        'CODE'#9'5'#9'Code'
        'DESCRIPTION'#9'43'#9'Description'
        'ORDER_NUMBER'#9'16'#9'ORDER_NUMBER')
  ...
  object TableSQL: TIBCQuery
    SQLInsert.Strings = (
      'INSERT INTO DELIVERY_TERM'
      
        '  (CODE, DESCRIPTION, FREIGHT_INCLUDED, INSURANCE_INCLUDED, ORDE' +
        'R_NUMBER)'
      'VALUES'
      
        '  (:CODE, :DESCRIPTION, :FREIGHT_INCLUDED, :INSURANCE_INCLUDED, ' +
        ':ORDER_NUMBER)')
    SQLDelete.Strings = (
      'DELETE FROM DELIVERY_TERM'
      'WHERE'
      '  CODE = :Old_CODE')
    SQLUpdate.Strings = (
      'UPDATE DELIVERY_TERM'
      'SET'
      
        '  CODE = :CODE, DESCRIPTION = :DESCRIPTION, FREIGHT_INCLUDED = :' +
        'FREIGHT_INCLUDED, INSURANCE_INCLUDED = :INSURANCE_INCLUDED, ORDE' +
        'R_NUMBER = :ORDER_NUMBER'
      'WHERE'
      '  CODE = :Old_CODE')
    SQLRefresh.Strings = (
      
        'SELECT CODE, DESCRIPTION, FREIGHT_INCLUDED, INSURANCE_INCLUDED, ' +
        'ORDER_NUMBER FROM DELIVERY_TERM'
      'WHERE'
      '  CODE = :CODE')
    SQLLock.Strings = (
      'SELECT NULL FROM DELIVERY_TERM'
      'WHERE'
      'CODE = :Old_CODE'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM DELIVERY_TERM'
      ''
      ') q')
    ...
    object TableSQLORDER_NUMBER: TIntegerField
      DisplayWidth = 16
      FieldName = 'ORDER_NUMBER'
    end
    object TableSQLFREIGHT_INCLUDED: TStringField
      FieldName = 'FREIGHT_INCLUDED'
      Visible = False
      Size = 1
    end
    object TableSQLINSURANCE_INCLUDED: TStringField
      FieldName = 'INSURANCE_INCLUDED'
      Visible = False
      Size = 1
    end
  end
