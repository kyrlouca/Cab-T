object M_customPaymentTypeFRM: TM_customPaymentTypeFRM
  Left = 365
  Top = 153
  ClientHeight = 558
  ClientWidth = 530
  ...
  object Panel3: TPanel
    ...
    object Grid1: TwwDBGrid
      ...
      Height = 253
      Selected.Strings = (
        'HAWB_TYPE'#9'2'#9'Hawb Type'
        'DESCRIPTION'#9'53'#9'Description'
        'ORDER_NUMBER'#9'10'#9'Order NO')
  ...
  object TableSQL: TIBCQuery
    ...
    KeyGenerator = 'GEN_CUSTOMS_HAWB_TYPE'
    SQLInsert.Strings = (
      'INSERT INTO CUSTOMS_HAWB_TYPE'
      '  (SERIAL_NUMBER, HAWB_TYPE, DESCRIPTION, ORDER_NUMBER)'
      'VALUES'
      '  (:SERIAL_NUMBER, :HAWB_TYPE, :DESCRIPTION, :ORDER_NUMBER)')
    SQLDelete.Strings = (
      'DELETE FROM CUSTOMS_HAWB_TYPE'
      'WHERE'
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLUpdate.Strings = (
      'UPDATE CUSTOMS_HAWB_TYPE'
      'SET'
      
        '  SERIAL_NUMBER = :SERIAL_NUMBER, HAWB_TYPE = :HAWB_TYPE, DESCRI' +
        'PTION = :DESCRIPTION, ORDER_NUMBER = :ORDER_NUMBER'
      'WHERE'
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLRefresh.Strings = (
      
        'SELECT SERIAL_NUMBER, HAWB_TYPE, DESCRIPTION, ORDER_NUMBER FROM ' +
        'CUSTOMS_HAWB_TYPE'
      'WHERE'
      '  SERIAL_NUMBER = :SERIAL_NUMBER')
    SQLLock.Strings = (
      'SELECT NULL FROM CUSTOMS_HAWB_TYPE'
      'WHERE'
      'SERIAL_NUMBER = :Old_SERIAL_NUMBER'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM CUSTOMS_HAWB_TYPE'
      ''
      ') q')
