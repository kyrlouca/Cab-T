...
//    aNode:=AddNodeText(HawbNode,'InBond',  'InBond');
//    aNode:=AddNodeText(HawbNode,'InBondSrvaCd',  'InBondSrvaCd');
//    aNode:=AddNodeText(HawbNode,'InBondFcltyCd',qrHawb.FieldByName('clearance_waiting_code').AsString);

//    aNode:=AddNodeText(HawbNode,'TdocNo',qrHawb.FieldByName('MAWB_ID').AsString);
//    aNode:=AddNodeText(HawbNode,'JD0100000000000001','JD0100000000000001');
