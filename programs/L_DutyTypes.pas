...
var
  L_DutyTypesFRM: TL_DutyTypesFRM;
...
procedure TL_DutyTypesFRM.BitBtn2Click(Sender: TObject);
begin
close;
end;

procedure TL_DutyTypesFRM.TableSQLBeforeEdit(
  DataSet: TDataSet);
begin
...
procedure TL_DutyTypesFRM.TableSRCStateChange(Sender: TObject);
begin
...
procedure TL_DutyTypesFRM.FormKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TL_DutyTypesFRM.TableSQLAfterInsert(DataSet: TDataSet);
begin
...
procedure TL_DutyTypesFRM.FormActivate(Sender: TObject);
Var
