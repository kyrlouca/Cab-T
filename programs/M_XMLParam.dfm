object M_XmlParamFRM: TM_XmlParamFRM
  Left = 365
  Top = 153
  Caption = 'Instructor'
  ClientHeight = 558
  ...
  object TableSQL: TIBCQuery
    SQLInsert.Strings = (
      'INSERT INTO GENERAL_PARAMETER'
        ...
        '  (CODE, TEXT_1, TEXT_2, NUMERIC_1, NUMERIC_2, INTEGER_1, INTEGE' +
        'R_2, DATE_1, NUMERIC_6, INT_1, INT_2, INT_3, STR_1, STR_2, STR_3' +
        ', FLOAT_1, FLOAT_2, FLOAT_3, DESCRIPTION, STR_4, STR_5, STR_6)'
      'VALUES'
      
        '  (:CODE, :TEXT_1, :TEXT_2, :NUMERIC_1, :NUMERIC_2, :INTEGER_1, ' +
        ':INTEGER_2, :DATE_1, :NUMERIC_6, :INT_1, :INT_2, :INT_3, :STR_1,' +
        ' :STR_2, :STR_3, :FLOAT_1, :FLOAT_2, :FLOAT_3, :DESCRIPTION, :ST' +
        'R_4, :STR_5, :STR_6)')
    SQLDelete.Strings = (
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        '  CODE = :CODE, TEXT_1 = :TEXT_1, TEXT_2 = :TEXT_2, NUMERIC_1 = ' +
        ':NUMERIC_1, NUMERIC_2 = :NUMERIC_2, INTEGER_1 = :INTEGER_1, INTE' +
        'GER_2 = :INTEGER_2, DATE_1 = :DATE_1, NUMERIC_6 = :NUMERIC_6, IN' +
        'T_1 = :INT_1, INT_2 = :INT_2, INT_3 = :INT_3, STR_1 = :STR_1, ST' +
        'R_2 = :STR_2, STR_3 = :STR_3, FLOAT_1 = :FLOAT_1, FLOAT_2 = :FLO' +
        'AT_2, FLOAT_3 = :FLOAT_3, DESCRIPTION = :DESCRIPTION, STR_4 = :S' +
        'TR_4, STR_5 = :STR_5, STR_6 = :STR_6'
      'WHERE'
      '  CODE = :Old_CODE')
    SQLRefresh.Strings = (
      
        'SELECT CODE, TEXT_1, TEXT_2, NUMERIC_1, NUMERIC_2, INTEGER_1, IN' +
        'TEGER_2, DATE_1, NUMERIC_6, INT_1, INT_2, INT_3, STR_1, STR_2, S' +
        'TR_3, FLOAT_1, FLOAT_2, FLOAT_3, DESCRIPTION, STR_4, STR_5, STR_' +
        '6 FROM GENERAL_PARAMETER'
      'WHERE'
      '  CODE = :CODE')
    SQLLock.Strings = (
    ...
    SQL.Strings = (
      ...
      '*'
      'FROM'
      'General_parameter order by code')
    Active = True
    ...
    object TableSQLTEXT_2: TStringField
      DisplayLabel = 'Description'
      DisplayWidth = 47
      FieldName = 'TEXT_2'
      Size = 160
    end
    object TableSQLTEXT_1: TStringField
      DisplayLabel = 'Value'
      DisplayWidth = 63
      FieldName = 'TEXT_1'
      Size = 160
